...
# from clustercontrast_old import models
...
def main_worker(args):
    ...
    sys.stdout = Logger(osp.join(args.checkpoint_dir, 'test_log.txt'))
    print("==========\nArgs:{}\n==========".format(args))
...
#################################
    ...
    checkpoint = load_checkpoint(osp.join(args.checkpoint_dir, 'model_best.pth.tar'))
